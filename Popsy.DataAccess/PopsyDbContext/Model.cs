...
namespace Popsy
{
    ...
    public sealed partial class PopsyDbContext
    {
        ...
        public DbSet<TblOrdenesDeCompraEntity> TblOrdenesDeCompra { get; set; }
        public DbSet<TblDetalleOrdenesDeCompraEntity> TblDetalleOrdenesDeCompra { get; set; }
        public DbSet<TblProveedoresRecepcionEntity> TblProveedoresRecepcion { get; set; }
